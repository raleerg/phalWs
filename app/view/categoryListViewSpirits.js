...
Ext.define("IpadApp.view.categoryListViewSpirits", {
    extend: "Ext.dataview.List",
    alias: "widget.categoryListViewSpirits",
    initialize: function() {
        ...
        var dataViewBox = Ext.create('Ext.NestedList', {
            ...
            listeners: {
                leafitemtap: function(nestedList, list, index, target, record) {
                    ...
                    detailCard.setHtml('<div class="detail-card-content">'+ genButton +'<h1>' + record.get('text') + '</h1>' + '<p>' + record.get('content') + '</p>'+ img +'</div>' );
                },
                load : function() {
